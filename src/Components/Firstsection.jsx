      ...
      <div className="mx-auto  px-4 py-8 bg-black sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 mb-20 gap-40 lg:grid-cols-2 lg:gap-16">
          <div className="relative h-80  rounded-lg sm:h-80 lg:order-last lg:h-full">
            ...
            <img className="cursor-pointer relative  mt-24 ml-40 hover:shadow-outline" src="/spider.jpeg"   alt="Guardian" width="250" />
            <GoPlay  className="text-white text-8xl absolute mb-96 ml-40 widht "/>
          </div>

          <div className=" mb-6 ml-28 lg:py-24">
            <h2 className="text-3xl text-white font-bold sm:text-4xl">FIND MOVIES</h2>
            <p className=" text-5xl text-white  font-bold  inline-block from-[#0d00ffae]  to-[#fb153b]  text-transparent bg-clip-text  sm:text-4xl">TV SHOWS AND MORE</p>
